...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-bar-chart"></i> Daily Reports
        <small>track daily vehicle inspection</small>
      </h1>
    </section>
    <section class="content">
        <div class="row">
          <form action="<?php echo base_url() ?>dailyReports" method="POST" id="searchList">
                    ...
                    <tr>
                      ...
                      ?></td>
                       <td class="text-center">
                          <a class="btn btn-sm btn-primary" href="<?= base_url().'viewInspectionDetail/'.$record->answerid.'/'.'daily'; ?>" title="view detail"><i class="fa fa-eye"></i></a> 
                        </td>
                    </tr>
                    <?php
                        }

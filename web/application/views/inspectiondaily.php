<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-check-square-o"></i> Daily Inspections
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addNewDailyInsp"><i class="fa fa-plus"></i> New Daily Inspection</a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>dailyInsp" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <?php
                    if(!empty($dailyinspinfo))
                    {
                        foreach($dailyinspinfo as $record)
                        {
                    ?>
                    <tr>
